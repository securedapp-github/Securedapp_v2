...
export const faqsData = [
  [
    {
      q: "How long does it take to develop an NFT platform?",
      a: "The time required to develop an NFT platform depends on the complexity of the project, the features required, and the specific needs of the client. On average, it can take several weeks to a few months from the initial concept to the final deployment.",
    },
    {
      q: "What blockchain platforms do you support for NFT development?",
      a: "We support various blockchain platforms, including Ethereum, Binance Smart Chain, Solana, and others, depending on the client's needs and the nature of the NFT project.",
    },
    {
      q: "Can I customize my NFT marketplace?",
      a: "Yes, our NFT development services allow for full customization of your marketplace, including design, features, and functionality, to match your brand and meet your specific business goals.",
    },
    {
      q: "How do you ensure the security of NFTs and the platform?",
      a: "Security is a top priority in our NFT development services. We implement smart contract audits, encryption protocols, and secure blockchain integrations to ensure that your NFT platform and assets are protected against vulnerabilities and attacks.",
    },
    {
      q: "How do you ensure compliance with legal and regulatory requirements for NFTs?",
      a: "We stay updated on legal and regulatory developments related to NFTs and blockchain technology. Our development process includes ensuring compliance with relevant laws and regulations, such as intellectual property rights, anti-money laundering (AML) requirements, and data protection standards.",
    },
  ],
];
