...
const Sales = (props: Props) => {
  return (
    <div>
      <div className="bg-grid-bg min-h-screen bg-no-repeat dark:bg-griddark-bg bg-center flex items-center justify-center">
        <div className="text-center">
          ...
          <div className="lg:flex lg:justify-center gap-10 space-x-3 lg:space-x-0 py-5">
            ...
            <button onClick={() =>
              ...
              className="lg:text-2xl bg-transparent border-green-500 px-5 py-2 rounded-2xl hover:bg-green-600 text-white dark:text-black border hover:border-black scale-100 hover:scale-105 transform transition"
              id="poppins-medium"
            >
              Talk To Us
            </button>
