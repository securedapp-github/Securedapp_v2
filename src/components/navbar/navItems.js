export const navItems = [
  {
    ...
    items: [
      ...
      { name: "SecureWatch", to: "/real-time-blockchain-threat-monitoring" },
      { name: "AuditExpress", to: "/audit-express" },
      { name: "SecurePad", to: "/tokenization-platform" },
      { name: "SecureX-ID", to: "/web3-identity-and-aml-compliance-platform" },
      { name: "QuantumVault", to: "/enterprise-hsm-key-management-platform" },
    ],
    label: "Product",
  },
  {
