...
export const faqsData = [
  [
    {
      q: "How does Blockchain Forensics support law enforcement?",
      a: "Blockchain forensics provides law enforcement agencies with detailed insights into blockchain transactions, helping them build stronger cases against criminals. It also facilitates collaboration with regulatory bodies to establish compliance standards and best practices.",
    },
    {
      q: "What is the difference between Blockchain Forensics and On-Chain Analysis?",
      a: "While both involve analyzing blockchain data, blockchain forensics specifically focuses on investigating and tracing illicit activities. On-chain analysis, on the other hand, is a broader term that includes examining transaction data for various purposes, such as market insights, compliance, and risk management.",
    },
    {
      q: "What industries benefit from Blockchain Forensics?",
      a: "Blockchain forensics is not limited to a single industry. It benefits multiple sectors, including finance, healthcare, supply chain, and digital asset exchanges, making it a relevant and valuable tool for professionals across different fields.",
    },
    {
      q: "How does Blockchain Forensics handle complex transactions?",
      a: "Blockchain forensics uses sophisticated algorithms and tools to analyze complex transactions, trace the flow of funds across multiple addresses, and identify patterns that may indicate illicit activities.",
    },
    {
      q: "What is the future of Blockchain Forensics?",
      a: "The future of blockchain forensics looks promising as a Web 3.0 ecosystem continues to evolve. The development of more advanced tools and techniques will enhance its effectiveness in combating illicit activities, paving the way for a more secure digital future.",
    },
  ],
];
...
export const impactData = [
  ...
  },
  {
    ...
    description: `• Improved Transparency<br/>
